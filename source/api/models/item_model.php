...
class ItemModel extends BaseModel
{
    ...
    protected $ClassName = 'ItemModel'; // Must be the same as the class name.
    ...
    public function create($payload){
        ...
        // 3 strings (%s) for three statements ($).
        ...
        // insert_id is a keyword and will return the ID of the insertion.
